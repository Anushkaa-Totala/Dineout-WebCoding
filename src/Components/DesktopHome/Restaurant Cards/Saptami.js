...
export default function Saptami() {
    ...
    <Card className={classes.root}>
      ...
      <Grid container spacing={1}
        ...
        <Grid item lg={12}> <CardMedia
          ...
          image='https://im1.dineout.co.in/images/uploads/restaurant/sharpen/6/f/p/p6495-15706215235d9dc85303c63.jpg?tr=tr:n-medium'
          title="Paella dish"
        /></Grid>

        <Grid item lg={4.5}>
          <Typography className={classes.name}> Saptami </Typography>
        </Grid>
