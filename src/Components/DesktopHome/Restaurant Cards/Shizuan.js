...
export default function Shizuan() {
    ...
    <Card className={classes.root}>
      ...
      <Grid container spacing={1}
        ...
        <Grid item lg={12}> <CardMedia
          ...
          image='https://im1.dineout.co.in/images/uploads/restaurant/sharpen/5/v/y/p58401-15657014385d52b53e5d2e0.jpg?tr=tr:n-medium'
          title="Paella dish"
        /></Grid>

        <Grid item lg={4.5}>
          <Typography className={classes.name}> Shizuan </Typography>
        </Grid>
