...
export default function Zyutun() {
    ...
    <Card className={classes.root}>
      ...
      <Grid container spacing={1}
        ...
        <Grid item lg={12}> <CardMedia
          ...
          image='https://im1.dineout.co.in/images/uploads/restaurant/sharpen/2/g/a/p27013-147566997657f4efd8b7973.jpg?tr=tr:n-medium'
          title="Paella dish"
        /></Grid>

        <Grid item lg={4.5}>
          <Typography className={classes.name}> Zyutun </Typography>
        </Grid>
