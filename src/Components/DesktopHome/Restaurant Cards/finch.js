    ...
    <Card className={classes.root}>
      ...
      <Grid container spacing={1}
        ...
        <Grid item lg={12}> <CardMedia
          ...
          image='https://im1.dineout.co.in/images/uploads/restaurant/sharpen/2/c/q/p20150-15153969615a531f6180c6f.jpg?tr=tr:n-small'
          title="Paella dish"
        /></Grid>

        <Grid item lg={4.5}>
          <Typography className={classes.name}> The Finch </Typography>
        </Grid>
        ...
        <Grid item lg={9}>
          <Typography className={classes.body}>Chandivali, Powai. </Typography>
