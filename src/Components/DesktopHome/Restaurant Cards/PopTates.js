...
export default function PopTates() {
    ...
    <Card className={classes.root}>
      ...
      <Grid container spacing={1}
        ...
        <Grid item lg={12}> <CardMedia
          ...
          image='https://im1.dineout.co.in/images/uploads/restaurant/sharpen/7/s/v/p73265-15776215315e08981bb0c73.jpg?tr=tr:n-large'
          title="Paella dish"
        /></Grid>

        <Grid item lg={4.5}>
          <Typography className={classes.name}> Pop Tates </Typography>
        </Grid>
