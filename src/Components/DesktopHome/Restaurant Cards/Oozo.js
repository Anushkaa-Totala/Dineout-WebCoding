    ...
    <Card className={classes.root}>
      ...
      <Grid container spacing={1}
        ...
        <Grid item lg={12}> <CardMedia
          ...
          image='https://im1.dineout.co.in/images/uploads/restaurant/sharpen/3/q/u/p33161-150098031159772457184c1.jpg?tr=tr:n-medium'
          title="Paella dish"
        /></Grid>

        <Grid item lg={4.5}>
          <Typography className={classes.name}> Oozo </Typography>
        </Grid>
        ...
        <Grid item lg={9}>
          <Typography className={classes.body}>2058, Juhu.</Typography>
