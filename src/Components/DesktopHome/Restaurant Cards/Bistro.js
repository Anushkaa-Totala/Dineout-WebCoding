    ...
    <Card className={classes.root}>
      ...
      <Grid container spacing={1}
        ...
        <Grid item lg={12}> <CardMedia
          ...
          image='https://im1.dineout.co.in/images/uploads/restaurant/sharpen/3/l/p/p35064-150538514759ba5abbddaef.jpg?tr=tr:n-medium'
          title="Paella dish"
        /></Grid>

        <Grid item lg={4.5}>
          <Typography className={classes.name}> Bistro </Typography>
        </Grid>
        ...
        <Grid item lg={9}>
          <Typography className={classes.body}>Andheri West </Typography>
