    ...
    <Card className={classes.root}>
      ...
      <Grid container spacing={1}
        ...
        <Grid item lg={12}> <CardMedia
          ...
          image='https://im1.dineout.co.in/images/uploads/restaurant/sharpen/8/a/p/p8326-1468491779578768032fef1.jpg?tr=tr:n-small'
          title="Paella dish"
        /></Grid>

        <Grid item lg={4.5}>
          <Typography className={classes.name}> Episode 1 </Typography>
        </Grid>
        ...
        <Grid item lg={9}>
          <Typography className={classes.body}>1056, Lokhandwaala </Typography>
